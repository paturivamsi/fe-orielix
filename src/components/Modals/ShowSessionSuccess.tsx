...
export type ShowSessionSuccessProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    session: SessionType;
}

export const ShowSessionSuccess = ({ open, onOpenChange, session }: ShowSessionSuccessProps) => {
    const { name, date } = session;
    return (
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-6">
                                You have successfully registered for <span className="font-semibold text-indigo-700">{name}</span> on {dayjs(date).format("MMM DD, YYYY")}.
                            </p>

                            <p className="text-sm text-gray-500 mb-8">
                                A confirmation email has been sent with all Session details and your registration code.
                            </p>
